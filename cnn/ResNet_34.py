...
class ResNet_34(Network):
    ...
    def setup(self):
        ...
        (self.residual_v1('pool1', 64, 64, 1, name='res1_1'))
        (self.residual_v1('res1_1', 64, 64, 1, name='res1_2'))
        (self.residual_v1('res1_2', 64, 64, 1, name='res1_3'))

        (self.residual_v1('res1_3', 128, 128, 2, name='res2_1'))
        (self.residual_v1('res2_1', 128, 128, 1, name='res2_2'))
        (self.residual_v1('res2_2', 128, 128, 1, name='res2_3'))
        (self.residual_v1('res2_3', 128, 128, 1, name='res2_4'))

        (self.residual_v1('res2_4', 256, 256, 2, name='res3_1'))
        (self.residual_v1('res3_1', 256, 256, 1, name='res3_2'))
        (self.residual_v1('res3_2', 256, 256, 1, name='res3_3'))
        (self.residual_v1('res3_3', 256, 256, 1, name='res3_4'))
        (self.residual_v1('res3_4', 256, 256, 1, name='res3_5'))
        (self.residual_v1('res3_5', 256, 256, 1, name='res3_6'))

        (self.residual_v1('res3_6', 512, 512, 2, name='res4_1'))
        (self.residual_v1('res4_1', 512, 512, 1, name='res4_2'))
        (self.residual_v1('res4_2', 512, 512, 1, name='res4_3'))
...
if __name__ == '__main__':
    net = ResNet_34(X_size=[227,227,3], Y_size=[n_classes], name='ResNet')
